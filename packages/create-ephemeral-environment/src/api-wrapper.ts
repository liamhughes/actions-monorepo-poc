...
export async function createEphemeralEnvironmentFromInputs(
  client: Client,
...
export async function GetExistingEnvironmentIdByName(
  client: Client,
...
export async function GetEnvironmentProjectStatus(
  client: Client,
